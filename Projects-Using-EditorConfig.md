...
[A11Y Project](http://a11yproject.com) ([source](https://github.com/a11yproject/a11yproject.com/blob/main/.editorconfig)) -- A11Y Project : A community-driven effort to make web accessibility easier.
...
[PHP](https://www.php.net/) ([source](https://github.com/php/php-src)) -- The PHP programming language
...
[roslyn](https://github.com/dotnet/roslyn#readme) ([source](https://github.com/dotnet/roslyn/blob/master/.editorconfig)) -- The Roslyn .NET compiler provides C# and Visual Basic languages with rich code analysis APIs.
...
[SquirrelFramework](https://github.com/imnista/SquirrelFramework) ([source](https://github.com/imnista/SquirrelFramework/blob/master/src/.editorconfig)) -- A lightweight .NET back-end framework and utilities kit based on MongoDB/Cosmos DB.
